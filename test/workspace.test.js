...
import { librarySequenceToggleVisibleForTool, computeLayerMarkState } from '../js/workspace.js';
...
// Layers panel marking (multi-select) is DOM-bound in buildLayerRow's click
// handler, so - same boundary as librarySequenceToggleVisibleForTool above -
// only the pure state-transition function is unit-tested; the actual click
// wiring is covered by manual verification (merge-layers change's tasks.md
// 4.2).
