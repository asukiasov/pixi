...
Keeps the browser URL in sync with the current screen (Gallery, New Canvas, or a specific project's Workspace) so reloading, bookmarking, and Back/Forward navigation all behave the way a normal web app's would.
