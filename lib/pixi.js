...
<header class="workspace-topbar">
  ...
  <button type="button" id="tile-preview-toggle" class="tool-button icon-button magnetic-hover" aria-label="Tile preview" data-tooltip="Tile preview">
...
<div class="workspace-main">
  <div id="workspace-canvas-container" class="canvas-container">
    <div id="workspace-tile-wrapper" class="workspace-tile-wrapper">
      <canvas id="workspace-canvas"></canvas>
      <canvas class="tile-preview-copy" aria-hidden="true"></canvas>
      <canvas class="tile-preview-copy" aria-hidden="true"></canvas>
      <canvas class="tile-preview-copy" aria-hidden="true"></canvas>
      <canvas class="tile-preview-copy" aria-hidden="true"></canvas>
      <canvas class="tile-preview-copy" aria-hidden="true"></canvas>
