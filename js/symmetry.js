...
// (see design.md for the wrap-applyPixel-don't-fork-the-stroke-tracer
// rationale and test/symmetry.test.js for coverage).
 ...
 * needed (see design.md's "Axis fixed at floor(width/2)/floor(height/2)"
 * decision).
 *
