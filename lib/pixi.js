...
export const Pixi = {
  ...
  mount(hostElement, options = {}) {
    ...
    container.id = 'screen-workspace';
    container.className = 'screen workspace-screen';
    container.innerHTML = WORKSPACE_MARKUP;
    hostElement.appendChild(container);

    const layerStack = new LayerStack(width, height);
    const canvasEl = container.querySelector('#workspace-canvas');
    const canvasContainerEl = container.querySelector('#workspace-canvas-container');
