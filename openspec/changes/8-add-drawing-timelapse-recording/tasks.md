...
- [ ] 4.2 Confirm no network requests are made during recording or Save
      (client-side-only, per the confirmed scope).
- [ ] 4.3 Update `docs/ui-reference.md` with the new toggle/popover's ids
